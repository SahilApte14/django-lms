...
st.markdown(
    ...
    <style>
    body {
        background-color: #ffffff; /* Set your desired background color code */
    }
    </style>
    """,
...
st.markdown("<h2 style='text-align: center; color: blue;'>Course Suggestions</h2>", unsafe_allow_html=True)
