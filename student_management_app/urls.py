...
urlpatterns = [
    ...
    path('student_course_recomendation',StudentViews.student_course_recomendation,name="student_course_recomendation"),
    path('student_askgpt',StudentViews.student_askgpt,name="student_askgpt"),
]
